...
public class Mapshower : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if(showProvBorder)
        {
            GetComponent<Renderer>().material.SetInteger("_ShowProvBorder", 1);
        }
        else
            GetComponent<Renderer>().material.SetInteger("_ShowProvBorder", 0);
    }

    public void runMapShower()
    {
